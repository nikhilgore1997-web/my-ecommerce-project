        ...
        <Row>
          ...
          <Col md={4}>
            ...
            <ul className="list-unstyled">
              <li>
                <a href="/mens" className="text-white text-decoration-none">Men</a>
              </li>
              <li>
                <a href="/womens" className="text-white text-decoration-none">Women</a>
              </li>
              <li>
                <a href="/kids" className="text-white text-decoration-none">Kids</a>
              </li>
              <li>
                <a href="/admin" className="text-white text-decoration-none">Admin</a>
              </li>
            </ul>
          </Col>
